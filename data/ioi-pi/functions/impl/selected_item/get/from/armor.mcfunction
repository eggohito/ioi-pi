#> ioi-pi:impl/selected_item/get/from/armor
#
...
execute if data storage phi.modifyinv:temp armor[{tag: {ioi_pi: {selected: 1b}}}] run function ioi-pi:impl/selected_item/modify/from/armor
